...
router.get("/school-users/v1-10/placement-added", (req, res) => {
...
router.get("/school-users/v1-10/provider-added", (req, res) => {
...
router.get("/school-users/v1-10/itt-added", (req, res) => {
...
router.get("/school-users/v1-10/user-added", (req, res) => {
...
router.get("/school-users/v1-10/skip-onboarding", (req, res) => {
...
router.get("/school-users/v1-10/signin-redirect", (req, res) => {
...
router.get("/school-users/v1-10/onboarding-add-itt-contact-answer", (req, res) => {
...
router.get("/school-users/v1-10/onboarding-add-users-answer", (req, res) => {
...
router.get("/school-users/v1-10/onboarding-complete", (req, res) => {
    req.session.data.onboarding = "false"
