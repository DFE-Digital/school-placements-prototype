...
router.get("/school-users/v1-13/placement-added", (req, res) => {
...
router.get("/school-users/v1-13/provider-added", (req, res) => {
...
router.get("/school-users/v1-13/itt-added", (req, res) => {
...
router.get("/school-users/v1-13/user-added", (req, res) => {
...
router.get("/school-users/v1-13/skip-onboarding", (req, res) => {
...
router.get("/school-users/v1-13/signin-redirect", (req, res) => {
...
router.get("/school-users/v1-13/onboarding-add-itt-contact-answer", (req, res) => {
...
router.get("/school-users/v1-13/onboarding-add-users-answer", (req, res) => {
...
router.get("/school-users/v1-13/onboarding-complete", (req, res) => {
    req.session.data.onboarding = "false"
