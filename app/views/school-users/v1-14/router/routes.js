...
router.get("/school-users/v1-14/placement-added", (req, res) => {
...
router.get("/school-users/v1-14/provider-added", (req, res) => {
...
router.get("/school-users/v1-14/itt-added", (req, res) => {
...
router.get("/school-users/v1-14/user-added", (req, res) => {
