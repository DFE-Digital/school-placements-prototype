...
router.get("/school-users/v1-12/placement-added", (req, res) => {
...
router.get("/school-users/v1-12/provider-added", (req, res) => {
...
router.get("/school-users/v1-12/itt-added", (req, res) => {
...
router.get("/school-users/v1-12/user-added", (req, res) => {
...
router.get("/school-users/v1-12/skip-onboarding", (req, res) => {
...
router.get("/school-users/v1-12/onboarding-add-itt-contact-answer", (req, res) => {
...
router.get("/school-users/v1-12/onboarding-add-users-answer", (req, res) => {
...
router.get("/school-users/v1-12/onboarding-complete", (req, res) => {
    req.session.data.onboarding = "false"
